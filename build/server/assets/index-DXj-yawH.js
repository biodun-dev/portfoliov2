...
import { r as removeLights, c as cleanScene, a as cleanRenderer, t as textureLoader, m as modelLoader } from "./three-CWl8dl3P.js";
...
const Device = ({
  ...
  useEffect(() => {
    ...
    return () => {
      animation == null ? void 0 : animation.stop();
    };
  }, [loadDevice, show]);
};
export {
