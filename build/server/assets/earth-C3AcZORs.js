...
import { u as useInViewport, b as useWindowSize, d as numToPx, e as media, a as classes, T as Transition, m as msToNum, S as Section, L as Loader, t as tokens, f as clamp } from "./server-build-ChNqiQLF.js";
...
import { Vector3, WebGLRenderer, SRGBColorSpace, ACESFilmicToneMapping, PerspectiveCamera, Scene, Clock, Raycaster, AmbientLight, DirectionalLight, PMREMGenerator, Sprite, Vector2, LoopOnce, EquirectangularReflectionMapping, LinearFilter, AnimationMixer } from "three";
import { r as removeLights, c as cleanScene, a as cleanRenderer, g as getChild, t as textureLoader, m as modelLoader } from "./three-OLBG64MB.js";
...
const getPositionValues = (section2) => {
  if (!section2 || !section2.camera) return nullTarget;
  return {
    x: section2.camera[0],
    y: section2.camera[1],
    z: section2.camera[2]
